...
/**
 * A client handler exception thrown by a client handler that signals a failure
 * to process the HTTP request or HTTP response. Client handler exception message
 * or underlying {@link Throwable} cause SHOULD contain additional information
...
public class ClientHandlerException extends RuntimeException {
    ...
    private static final long serialVersionUID = -1688663122482633395L;
     ...
     * automatically incorporated in this client handler exception's detail
     * message.
     *
    ...
    /**
     * Constructs a new client handler exception with the specified cause and a
     * detail message of {@code (cause==null ? null : cause.toString())}
     * (which typically contains the class and detail message of {@code cause}).
     * This constructor is useful for client handler exceptions that are little
