...
\newcommand{\ClientFactory}{\code{ClientFactory}}
\newcommand{\ClientBuilderFactory}{\code{ClientBuilderFactory}}
\newcommand{\ClientConfiguration}{\code{ClientConfiguration}}
\newcommand{\Link}{\code{Link}}
\newcommand{\Invocation}{\code{Invocation}}
\newcommand{\HttpRequest}{\code{core.HttpRequest}}
\newcommand{\HttpResponse}{\code{core.HttpResponse}}
\newcommand{\Configurable}{\code{Configurable}}
\newcommand{\InvocationBuilder}{\code{Invocation.Builder}}


\newcommand{\RequestFilter}{\code{RequestFilter}}
\newcommand{\ResponseFilter}{\code{ResponseFilter}}
\newcommand{\FilterContext}{\code{FilterContext}}
\newcommand{\ReadFromHandler}{\code{ReadFromHandler}}
\newcommand{\WriteToHandler}{\code{WriteToHandler}}
\newcommand{\ReadFromHandlerContext}{\code{ReadFromHandlerContext}}
\newcommand{\WriteToHandlerContext}{\code{WriteToHandlerContext}}
\newcommand{\MessageBodyReader}{\code{MessageBodyReader}}
\newcommand{\MessageBodyWriter}{\code{MessageBodyWriter}}
\newcommand{\DynamicBinding}{\code{DynamicBinding}}

\newcommand{\NameBinding}{\code{@NameBinding}}
\newcommand{\GlobalBinding}{\code{@GlobalBinding}}
\newcommand{\BindingPriority}{\code{@BindingPriority}}
...
\newcommand{\Suspend}{\code{@Suspend}}
\newcommand{\AsyncContext}{\code{AsyncContext}}
