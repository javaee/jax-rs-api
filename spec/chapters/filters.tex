...
Name binding annotations can also be applied to \code{Application} subclasses for the purpose of binding a filter or interceptor globally for that application. For example,
