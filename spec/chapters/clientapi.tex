...
\item [Providers] Classes or instances of classes annotated by \Provider. A provider can be a message body reader, a filter, a context resolver, etc. See Chapter \ref{providers} for more information.
\end{description}
