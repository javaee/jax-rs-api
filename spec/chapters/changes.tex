...
\item Section \ref{suspend_annotation}: Improved example.
...
\item Section \ref{uri_annotation}: New section that explains the use of the \code{@Uri} annotation.
...
\item Section \ref{suspend_annotation}: Throw new exception \code{ServiceUnavailableException}.
