...
\item[Filter] A class that implements \code{RequestFilter} or \code{ResponseFilter} (or both) and is annotated with \Provider.
\item[Handler] A class that implements \code{ReadFromHandler} or \code{WriteFromHandler} (or both) and is annotated with \Provider.
