...
\item[Filter] A class that implements \code{RequestFilter} or \code{ResponseFilter} (or both) and is registered as a provider.
\item[Handler] A class that implements \code{ReadFromHandler} or \code{WriteFromHandler} (or both) and is registered as a provider.
