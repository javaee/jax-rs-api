...
It is RECOMMENDED for \jaxrs\ implementations to provide asynchronous processing support, as defined in Chapter \ref{asynchronous_processing}, by enabling asynchronous processing (i.e., \code{asyncSupported=true}) in the underlying Servlet 3 container.
